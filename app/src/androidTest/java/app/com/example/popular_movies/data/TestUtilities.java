...
import app.com.example.popular_movies.utils.PollingCheck;
...
public class TestUtilities extends AndroidTestCase {
    ...
    static ContentValues createMovieValues() {
       ...
       // movieValues.put(MovieContract.MovieEntry.COLUMN_POSTER_PATH, "/jjBgi2r5cRt36xF6iNUEhzscEcb.jpg");
        movieValues.put(MovieContract.MovieEntry.COLUMN_RATING, 5.1);
        movieValues.put(MovieContract.MovieEntry.COLUMN_RELEASE_DATE, "01/01/2015");
        movieValues.put(MovieContract.MovieEntry.COLUMN_TITLE, "Test Title");
        movieValues.put(MovieContract.MovieEntry.COLUMN_VOTE_COUNT, 355);
...
//        testValues.put(MovieContract.MovieEntry.COLUMN_LOCATION_SETTING, TEST_LOCATION);
//        testValues.put(MovieContract.MovieEntry.COLUMN_CITY_NAME, "North Pole");
//        testValues.put(MovieContract.MovieEntry.COLUMN_COORD_LAT, 64.7488);
//        testValues.put(MovieContract.MovieEntry.COLUMN_COORD_LONG, -147.353);
//
//        return testValues;
//    }
    ...
    static long insertMovieValues(Context context) {
        ...
        long movieId;
        movieId = db.insert(MovieContract.MovieEntry.TABLE_NAME, null, testValues);
        ...
        // Verify we got a row back.
        assertTrue("Error: Failure to insert Movie Values", cursor.moveToFirst());
